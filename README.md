...
This repository contains the replication code for the paper "Factor Interaction Structure in the Chinese A‑Share Market: A Study Based on AP‑Tree".
...
Data Download
Raw monthly stock and financial data are available on Zenodo (DOI: 10.5281/zenodo.20032245).
...
You may also run each script individually (dependencies must exist).

License
The code is released under the MIT License.
Raw data are provided under the same license.
